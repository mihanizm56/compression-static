module.exports = {
  ...
  types: [
    {
      value: 'build',
      name: 'build:     Сборка проекта или изменения внешних зависимостей или настройка проекта',
    },
    ...
    {
      value: 'performance',
      name: 'performance:      Изменения направленные на улучшение производительности',
    },
    {
      value: 'refactor',
